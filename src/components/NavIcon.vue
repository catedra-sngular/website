<template>
    <div class="hamburger-menu">
        ...
        <li><a class="menu__item" href="/#about-us">{{ locale.navbar.about_us }}</a></li>
        <li><a class="menu__item" href="/#objetivos">{{ locale.navbar.objectives }}</a></li>
        <li><a class="menu__item" href="/#actividades">{{ locale.navbar.activities }}</a></li>
        <li>
            <a class="menu__item">
